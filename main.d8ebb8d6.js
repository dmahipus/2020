...
},{}],"scripts/loading.js":[function(require,module,exports) {
"use strict";
...
},{"ev-emitter":"../node_modules/ev-emitter/ev-emitter.js"}],"scripts/scroll.js":[function(require,module,exports) {
"use strict";
...
var _imagesloaded = _interopRequireDefault(require("../../node_modules/imagesloaded/imagesloaded"));
...
var Smooth = /*#__PURE__*/function () {
  function Smooth() {
    ...
    this.dom = {
      ...
      item: document.querySelectorAll('[data-scroll-item]'),
      sm: document.querySelectorAll('[data-scroll-sm]')
    };
    this.rAF = null;
    this.init();
  }
  ...
  _createClass(Smooth, [{
    ...
    value: function preload() {
      ...
      (0, _imagesloaded.default)(this.dom.content, function (instance) {
        _this2.setHeight();
      });
    }
  }, {
    ...
    value: function run() {
      ...
      this.dom.item.forEach(function (item) {
        item.style.transform = "translate3D(0, -".concat(_this3.data.rounded * 0.05, "px, 0)\n                              rotate(-").concat(_this3.data.rounded * 0.0025, "deg)");
      });
      this.dom.sm.forEach(function (sm) {
        sm.style.transform = "translate3D(0, -".concat(_this3.data.rounded * 0.0025, "px, 0)");
      });
...
},{"../../node_modules/imagesloaded/imagesloaded":"../node_modules/imagesloaded/imagesloaded.js"}],"scripts/main.js":[function(require,module,exports) {
"use strict";

var _core = _interopRequireDefault(require("@barba/core"));

var _loading = require("../scripts/loading");
...
function getYear() {
  document.querySelector('.year').innerHTML = "&COPY; ".concat(new Date().getFullYear());
}
...
},{"@barba/core":"../node_modules/@barba/core/dist/barba.umd.js","../scripts/loading":"scripts/loading.js","../scripts/scroll":"scripts/scroll.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
